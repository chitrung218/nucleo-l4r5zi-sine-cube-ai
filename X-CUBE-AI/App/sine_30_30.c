...
#define AI_NET_OBJ_INSTANCE g_sine_30_30
 
#undef AI_SINE_30_30_MODEL_SIGNATURE
#define AI_SINE_30_30_MODEL_SIGNATURE     "74eb49ebc74261372a49e089e99f187f"
...
#define AI_TOOLS_DATE_TIME   "Mon Mar 15 12:07:01 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_SINE_30_30_N_BATCHES
#define AI_SINE_30_30_N_BATCHES         (1)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 30, 1, 1, 1), AI_STRIDE_INIT(4, 4, 120, 120, 120),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 240, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_30_30_IN_NUM, &serving_default_dense_3_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_30_30_OUT_NUM, &dense_2_output),
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_SINE_30_30_MODEL_NAME,
      .model_signature   = AI_SINE_30_30_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_sine_30_30_forward(ai_handle network, const ai_buffer* input)
{
